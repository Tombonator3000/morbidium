...
Status: 287 av 532 bilder i manifestet er levert. De 245 som mangler, er samlet i 59 ark og bilder fordelt på 9 lister, én ChatGPT-samtale per liste. I tillegg kommer 11 delark til oppskriftssystemet.
...
Rekkefølgen følger «Neste bestilling» i `DESIGN_BRIEF.md`: fiendene som synes mest først, møblene sist. Det som ikke har bilde ennå, tegnes av koden som før, så spillet får aldri hull.
