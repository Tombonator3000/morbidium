...
const R = {
  ...
  init(canvas) {
    ...
    this.coarse = !!(window.matchMedia && matchMedia('(pointer: coarse)').matches); this.dpr = Math.min(devicePixelRatio || 1, this.coarse ? 1.5 : 2); this.renderer.setPixelRatio(1);
  ...
  waterMat(kind, electric, full) {
    ...
    const P = { wet: ['#1f6f9a', '#59b4dc', '#e8fbff', .23, 1], tub: ['#2a7ea8', '#6ac2e0', '#ffffff', .3, 1], vomit: ['#5d6a1c', '#9fae3a', '#e4ec9a', .32, .9], soup: ['#8a5a14', '#d8a040', '#fff0b0', .3, .9], morb: ['#2a0a3a', '#6b2d8c', '#e0a8ff', .28, 1.4] }[kind] || ['#1f6f9a', '#59b4dc', '#fff', .23, 1];
