/* ============================================================
   ...
   ============================================================ */
const SET_DEF = { vol: .7, sfx: 1, amb: 1, mus: .8, kamera: 1, shake: 1, flash: true, distort: true, lights: true, simple: false, tall: true, bobler: true, skilt: true, ui: 1, tips: true, d3: true, kvalitet: 0, blod: true, lemmer: 'tynne', kombo: true, opptak: true, sv: 2 };
...
function applySettings() {
  ...
  D3.sett(s.d3 && !s.simple); D3.kvalitet(); STREK.tynn = s.lemmer !== 'tykke'; if (typeof Blod === 'object') Blod.sett(s.blod); if (typeof Lydbank === 'object') Lydbank.sett(s.opptak !== false);
