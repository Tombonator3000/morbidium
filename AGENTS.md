...
- `05_world.js` kollisjon, skade, pytter, rekvisitter, plukk · `10_art.js` tegninger i kode · `11_doll.js` papirdukker · `12_paint.js` malte nivåer
- `20_actors.js` spiller, fiender, sjefer, evner · `30_game.js` flyt, rom, tjenester, journal, HUD, hovedløkke · `00_head.html` HTML og CSS
