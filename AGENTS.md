...
- `20_actors.js` spiller, fiender, sjefer, evner · `22_sjefer.js` Overarkivaren og sjefenes signaturangrep · `25_items.js` kuriositeter, piller, groteske fiender · `30_game.js` flyt, rom, tjenester, journal, HUD, hovedløkke · `00_head.html` HTML og CSS
