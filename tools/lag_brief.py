...
UTV = {
  ...
  'historie_2': "a thick journal bound in cracked black skin with stitched seams, closed, lying on a pale whale rib bone, with a dark red ribbon bookmark hanging out and an old dip pen with one drop of purple ink beside it (the only text allowed: a faded gold 1887 and the initial M. on the cover)",
  'historie_3': "a cross-section below a building: a thin band of brick foundation at the top, and under it a black, ancient sea; in the water sleeps something vast and dark with one huge closed eye and slow curling limbs, and small violet sparks rise from it toward the foundation",
  'historie_4': "Ward Zero: a pale surgical gown hanging from a hook, with surgical instruments stitched into the fabric, surrounded by chains hanging from the dark above, each ending in a sharp hook, and a small silver bell to the side. Elegant, ritual and cold, not gory",
  ...
  'historie_slutt_sannheten': "a lone figure standing still on a stone quay at night in the rain, seen small from behind, and far out the black sea rising in one smooth swell, like a chest breathing in",
  'historie_slutt_gjentakelse': "a freshly made iron hospital bed with a blue blanket, a new admission form on the pillow, a small silver bell on the blanket, and a red curved arrow looping back to where it started",
  'historie_slutt_fornektelse': "a blank sheet of paper with nothing written on it, a red ribbon bookmark across it, and a slack iron chain lying over the edge",
  'prop_forstander': "an old man with a white beard in a long dark frock coat, sewn to his chair with fine silver hooks through the backs of his hands, thin chains running from the chair down into the floor; he sits behind an oversized wooden desk reading aloud from a thick black journal that lies open, with a green glass banker's lamp on the desk and dust on his shoulders, seen from the front. Quiet and tired, not a villain",
  'prop_venterom': "a small waiting room seen through parted heavy red velvet curtains set into a wall: red curtains on every side inside too, a floor with a black and white zigzag pattern, and a very small doctor in a white coat far too big for him sitting on a chair, waiting politely",
