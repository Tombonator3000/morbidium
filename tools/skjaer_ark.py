...
Originalarket flyttes til assets/innboks/behandlet/.  Bruk: python3 tools/skjaer_ark.py
"""
import json, shutil
...
INN, DELER = ROT / 'assets' / 'innboks', ROT / 'assets' / 'deler'
VIS = ['f', 'b', 's']
...
def main():
    ...
    if not ark: print('Ingen ark i innboksen.'); return
    for p in ark:
