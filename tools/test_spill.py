...
async def main():
    async with async_playwright() as p:
        ...
        await pg.evaluate("() => descend()"); await pg.wait_for_timeout(1800); await shot('10floor2')
        print("før død:", await pg.evaluate("() => { const P = MORBIDIUM.player; P.lastCause = \"kultist\"; P.invuln = 0; P.iframe = 0; const s = MORBIDIUM.state, d = hurt(P, 9999, { type: \"kultist\" }); return { s, d, hp: P.hp, alive: P.alive, depth: MORBIDIUM.depth }; }"))
